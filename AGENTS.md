# Infinite Brain OS, рабочий репозиторий (Codex и другие агенты)

Этот репозиторий: операционная система для ведения бизнеса с помощью ИИ-агентов. Здесь у
вас полная автономия на запись. Ваш ИИ-агент (Codex, Qwen Code или другой) выполняет тяжёлую работу; этот файл его ориентирует.
...
**Важно:** Проект использует `.qwen/` в качестве основной директории адаптера. Файл `QWEN.md` содержит ориентацию для Qwen Code, а `AGENTS.md` - для Codex и других агентов.
...
См. `QWEN.md`: эквивалент этого файла для Qwen Code. Оба файла зеркалят друг друга и
